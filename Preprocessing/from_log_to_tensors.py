...
def log_to_tensors(log, 
    ...
    train_data, val_data, test_data, num_pref_cat, num_suff_cat, pref_cat_cars, suff_cat_cars, num_activities, og_caseint_train, og_caseint_val, og_caseint_test = generate_tensordata_train_test(train_pref_suff,
                                                                                                                                     val_pref_suff, 
                                                                                                                                     test_pref_suff, 
                                                                                                                                     case_id, act_label, 
                                                                                                                                     cardinality_dict, 
                                                                                                                                     ...
                                                                                                                                     outcome,
                                                                                                                                     log_name)
    # Three additional tensors, containing the original interger case ID of each instance, 
    # for the training, validation, and test set are also returned (and written to disk)
    return train_data, val_data, test_data, og_caseint_train, og_caseint_val, og_caseint_test

    # These additional parameters are kind of redundant, since they can also be read from disk. 
